...
const characters = [
    ...
    new Person("マルゼンスキー", 39, 75, 72, 66, 58, "おそらくナウなヤング！","#ea504a"),
    new Person("フジキセキ", 23, 35, 25, 50, 61, "心はイケメンでございます","#444745"),
    new Person("オグリキャップ", 63, 42, 35, 24, 81, "おかわりいただけるだろうか？","#3a7ad2")
]
const resultvalue = [
    [
        [6,6,6,0,0],
