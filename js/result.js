...
function opentwitter(){
    let text="あなたに一番近いウマ娘は...%0D%0A「"+document.getElementsByClassName("horse-name")[0].innerHTML+"」でした！%0D%0A詳細結果はこちら⇨"+window.location.href+window.location.search+"%0D%0A"+"#ウマ娘シンダン"
